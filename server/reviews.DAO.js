...
export default class ReviewsDAO {
  static async injectDB(connect) {
    ...
    try {
        const dbName = process.env.DB_NAME || "cinereview";
        reviews = await connect.db(dbName).collection("reviews")
        console.log(`✅ Connected to collection: reviews in database: ${dbName}`)
    } catch (e) {
